...
Elasticsearch Cluster Node for the Analysis Cockpit.
...
The installation of the ``Elasticsearch Cluster Node for
...
- ``clusternode.conf`` generated by the Analysis Cockpit (see :ref:`setup/index:cluster node configuration`)
